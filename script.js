...
function renderDashboard() {
  ...
  document.getElementById("next-action-panel").innerHTML = nextAction
    ...
    : `<p class="muted">Add your first item to generate a next action.</p>`;
  ...
  document.getElementById("today-plan").innerHTML = todayPlan.length
    ? todayPlan
        ...
        .join("")
    : `<p class="muted">No study blocks today. Open Study Tools to regenerate if needed.</p>`;
  ...
  document.getElementById("dashboard-alerts").innerHTML = riskRows.join("") || `<p class="muted">No warnings right now.</p>`;
